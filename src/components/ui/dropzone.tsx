  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <label
        ...
        {...props}
        className={cn(
          'cursor-pointer rounded-sm bg-muted px-4 py-2 font-medium ring-offset-background transition-colors focus-within:outline-none hover:bg-muted/80 has-[input:focus-visible]:ring-2 has-[input:focus-visible]:ring-ring has-[input:focus-visible]:ring-offset-2',
          className
        )}
      >
        {children}
