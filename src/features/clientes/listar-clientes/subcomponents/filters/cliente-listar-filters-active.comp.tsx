...
export function ClientesListarFiltersActive() {
      ...
      >((validFilters, [key, value]) => {
        ...
        switch (key as keyof typeof filters) {
          case 'status':
            return {
              ...validFilters,
              ['situação']: clienteStatusOptions.find(
                (opt) => opt.value === value
              )?.label,
            }
          ...
          case 'regimeTributario':
            return {
              ...validFilters,
              ['regimeTributário']: clienteRegimeTributarioOptions.find(
                (opt) => opt.value === value
              )?.label,
            }

          case 'dataCriacaoFinal':
          case 'dataCriacaoInicial':
            return {
              ...validFilters,
              [key.replace('Criacao', 'Cadastro')]: ensureType(value, 'date')
